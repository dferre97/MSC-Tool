...
\section{Omitted proofs of Section~\ref{CH:MSO}}\label{app:sec-mso}
...
We show  that the two alternative definitions of $\onensymb$-MSC that we gave are equivalent.
