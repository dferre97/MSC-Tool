\section{Communicating finite state machines\label{app:cfsm}}
...
%\section{Conflict Graph}\label{app:conflict-graph}
...
\section{Proof of Theorem~\ref{thm:bounded-model-checking}}\label{proofbmc}
...
\begin{proof}
   ...
   be fixed. We showed in Section~\ref{CH:MSO} 
...
\section{Proof of Proposition~\ref{prop:co-weaksync}}
