...
At this stage, the difference between $\co$-MSCs and $\mb$-MSCs might be unclear. Section~\ref{CH:HIERARCHY} will clarify how all the classes of MSCs that we introduce are related to each other.
