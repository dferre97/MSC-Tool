...
\davidequestion{Why unmatched messages? What do they represent?}
...
We will now consider the class of MSCs for which there is a causally ordered system that can produce their behaviour.
...
\davide{Provide example of causally ordered MSC which is not mailbox}
