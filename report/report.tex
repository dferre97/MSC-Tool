...
\davidequestion{$[\ppformula \;\wedge\;]$ should be redundant.}
Given an MSC $\msc$, it is causally ordered if it satisfies the MSO formula
\[
...
\davidequestion{This does not match my definition of mailbox MSC, should I also give the alternative definition (the one in the concur paper) or rewrite everything according to my definition?}
...
\begin{figure}[h]
	...
	\caption{The relation between different variants of universally $k$-bounded MSCs, given $k \in \N$.}
