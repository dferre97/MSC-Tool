...
In literature, several possible implementations of causal ordering can be found. For instance, the algorithm described in \cite{DBLP:conf/wdag/SchiperES89} makes use of the logical vector clocks introduced by Fidge-Mattern \cite{Fidge88timestampsin, Mattern89virtualtime} to enforce causal ordering.
