...
\begin{proof}
   ...
   before which the local communicating automaton was in state $l$. See for instance~\cite[Theorem~3.4]{DBLP:journals/corr/abs-1904-06942} for a detailed proof.}
...
already ensured by any possible $\oneone$ behaviorof $\System$. The rest of the proof is identical to the 
$\oneone$ case.
