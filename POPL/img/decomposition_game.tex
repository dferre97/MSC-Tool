	...
	\begin{center}
		\begin{tikzpicture}[scale = .8]
			\begin{scope}
				...
				\draw[->] (8.4,-1.4) to[bend left = 20] (8.9,-1);
				\draw[->] (8.4,-1.7) to[bend right = 20] (8.9,-2);


			\end{scope}
			\begin{scope}[shift = {(3.5,0)}]
				\draw[gray,fill = gray, rounded corners, opacity=0.2] (-.3,.3) rectangle (2.3,-.8);
				\draw[red!30, thick, fill = red!30] (0,0) circle (0.1);
				\draw[Green, thick, fill = Green!20] (0,-.5) circle (0.1);
				\draw[Yellow!40, thick, fill = Yellow!40] (2,-.5) circle (0.1);
			...
			\begin{scope}[shift = {(5.9,0)}]
				...
				\draw[Green!40, thick, fill = Green!40] (1,-1.5) circle (0.1);
				\draw[Yellow, thick, fill = Yellow!20] (2,-2) circle (0.1);
				\draw[blue!30, thick, fill = blue!30] (2,-1) circle (0.1);
			...
			\begin{scope}[shift = {(8.4,0)}]
				...
				\draw[blue!30, thick, fill = blue!30] (2,-.7) circle (0.1);
				\draw[Green!40, thick, fill = Green!40] (1,-1.2) circle (0.1);
			...
			\begin{scope}[shift = {(8.4,0)}]
				...
				\draw[red!30, thick, fill = red!30] (1,-2) circle (0.1);
				\draw[Yellow!40, thick, fill = Yellow!40] (2,-2) circle (0.1);
