...
says that there are no unmatched send events. All MSCs of Fig.~\ref{fig:exmscs} satisfy the formula. Given a sentence $\phi$, i.e., a formula without free variables,
