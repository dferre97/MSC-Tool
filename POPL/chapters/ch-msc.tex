...
moreovre, ${\procrel} = {\procrel_1} \cup {\procrel_2} \cup R$,
...
We denote by $\asMSCs$, $\ppMSCs$, $\coMSCs$, $\mbMSCs$, $\onenMSCs$, $\nnMSCs$, $\rscMSCs$ the sets of all MSCs, $\pp$-MSCs, $\mb$-MSCs, $\onen$ MSCs, $\nn$ MSCs, and $\rsc$ MSCs, over the given sets $\Procs$ and $\Msg$, respectively. Please note that we do not differentiate between isomorphic MSCs.
