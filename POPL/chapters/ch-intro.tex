...
or \emph{receive} events. A send event $s$ and a receive event $r$ are said to be \emph{matching} if the message sent at $s$ is the one received at $r$. 
A distributed computation is the concurrent execution of each process. 
