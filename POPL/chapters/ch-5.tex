...
%
A \emph{linearization} of $\msc$ is a total order $\linrel \subseteq \Events \times \Events$
on the events that extends the happens-before relation $\happensbefore$ defined over $\msc$, ie. $\happensbefore \subseteq \linrel$.
