...
\davide{Should we say bounded \textbf{special} treewidth? I know that is equivalent for our purposes, but in the paper we never talk about normal treewidth, it could be confusing.}
\davide{I don't understand the word "conundrum". I looked it up and it is defined as an "intricate and difficult problem"... does it match what we are trying to say here?}